...
$query = "SELECT gallery.id, gallery.title, gallery.content, gallery.author_id, gallery.image, gallery.created_at, users.email as author_email
FROM gallery
JOIN users ON gallery.author_id = users.id;";
...
<main class="admin">
    <div class="container">
        ...
        <h3>Objavi sliku</h3>
        <form class="smpl-form" action="/misc/addGalleryAction.php" id="login-form" method="POST"
            ...
            <div class="form-group">
                ...
                <textarea name="content" id="content" cols="30" rows="10" maxlength="80" required></textarea>
            </div>
            <div class="form-group">
        ...
        <div class="main-container content-table">
            <div class="table-container">
                <div class="table-row heading">
                    <div class="row-item">Slika</div>
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    <div class="table-row">
                        <div class="row-item row-image">
                            <img src="data:' . $imageType . ';base64,' . $imageBase64 . '" alt="Gallery Image">
                            <p>' . $row['title'] . '</p>
                        </div>
                        <div class="row-item"><p>' . $shortContent . '</p></div>
                        <div class="row-item text-center">' . $row['created_at'] . ' </br> by ' . $row['author_email'] . '</div>
                        <div class="row-item">
                            <a href="/pages/galleryEdit.php?id=' . $row['id'] . '" class="btn edit">
                            ...
                            <a href="/misc/deleteRow.php?id=' . $row['id'] . '&table=gallery" class="btn delete">
